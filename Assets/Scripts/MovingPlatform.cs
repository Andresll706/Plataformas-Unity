...
public class MovingPlatform : MonoBehaviour {
	...
	void _DoMovement()
	{
		...
		Vector3 direction = (m_CurrentWaypoint.position - transform.position).normalized;
	...
	void _CheckArrived()
	{
        ...
        float remDist = (m_CurrentWaypoint.transform.position - transform.position).magnitude;
		Debug.Log(remDist + " , " + m_MinDistanceSqr);
